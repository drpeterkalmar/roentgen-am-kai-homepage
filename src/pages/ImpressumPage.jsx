      ...
      <div className="max-w-[800px] mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-8">
          ...
          <section className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Geschäftsführer</h2>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 py-4">
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Gesetzliche Berufsbezeichnung</h3>
              <p>Fachärzte für Radiologie (verliehen in Österreich)</p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Zugehörige Kammer</h3>
              <p>Österreichische Ärztekammer</p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Firmenbuchnummer</h3>
              <p>348028g</p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-2">UID-Nummer</h3>
              <p>ATU65813603</p>
            </div>
          </section>
