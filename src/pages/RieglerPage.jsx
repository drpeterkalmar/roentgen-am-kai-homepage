...
const RieglerPage = () => {
  ...
  const publications = [
    ...
    { text: "Becciolini M, Pivec C, Raspanti A, Riegler G. Ultrasound of the Ulnar Nerve: A Pictorial Review: Part 2: Pathological Ultrasound Findings. J Ultrasound Med. 2024", pdf: "/publications/Becciolini_2024_Ulnar_Nerve_Part2_Pathological.pdf" },
    { text: "Becciolini M, Pivec C, Raspanti A, Riegler G. Ultrasound of the Ulnar Nerve: A Pictorial Review: Part 1: Normal Ultrasound Findings. J Ultrasound Med. 2024", pdf: "/publications/Becciolini_2024_Ulnar_Nerve_Part1_Normal.pdf" },
    { text: "Becciolini M, Pivec C, Riegler G. Ultrasound of the Lateral Femoral Cutaneous Nerve: A Review of the Literature and Pictorial Essay. J Ultrasound Med. 2022", pdf: "/publications/Becciolini_2022_Lateral_Femoral_Cutaneous_Nerve.pdf" },
    { text: "Becciolini M, Raspanti A, De Scisciolo G, Riegler G. Radial nerve palsy: If in doubt, use ultrasound. J Clin Ultrasound. 2022", pdf: "/publications/Becciolini_2022_Radial_nerve_palsy.pdf" },
    { text: "Becciolini M, Pivec C, Raspanti A, Riegler G. Ultrasound of the Radial Nerve: A Pictorial Review. J Ultrasound Med. 2021", pdf: "/publications/Becciolini_2021_Radial_Nerve_Pictorial_Review.pdf" },
    { text: "Becciolini M, Pivec C, Riegler G. Ultrasound Imaging of the Deep Peroneal Nerve. J Ultrasound Med. 2021", pdf: "/publications/Becciolini_2021_Deep_Peroneal_Nerve.pdf" },
    { text: "Riegler G, Pivec C, Jengojan S, Mayer JA, Schellen C, Trattnig S, Bodner G. Cutaneous nerve fields of the anteromedial lower limb — Determination with selective ultrasound-guided nerve blockade. Clin Anat. 2021", pdf: "/publications/Riegler_2021_Cutaneous_nerve_anteromedial_lower_limb.pdf" },
    { text: "Pivec C, Bodner G, Mayer JA, Brugger PC, Paraszti I, Moser V, Traxler H, Riegler G. Novel demonstration of the anterior femoral cutaneous nerves using ultrasound. Ultraschall Med. 2018", pdf: "/publications/Pivec_2018_Anterior_Femoral_Cutaneous_Nerves.pdf" },
    { text: "Riegler G, Brugger PC, Gruber GM, Pivec C, Jengojan S, Bodner G. High-resolution ultrasound visualization of Pacinian corpuscles. Ultrasound in Medicine and Biology. 2018", pdf: "/publications/Riegler_2018_Pacinian_Corpuscles.pdf" },
    { text: "Riegler G, Jengojan S, Mayer JA, Pivec C, Platzgummer H, Brugger PC, Aszmann O, Bodner G. Ultrasound anatomical demonstration of the infrapatellar nerve branches. Arthroscopy. 2018", pdf: "/publications/Riegler_2018_Infrapatellar_Nerve_Branches.pdf" },
    { text: "Riegler G, Lieba-Samal D, Brugger PC, Pivec C, Platzgummer H, Vierhapper M, Muschitz G, Jengojan S, Bodner G. High-resolution ultrasound visualization of the deep branch of the ulnar nerve. Muscle Nerve. 2017", pdf: "/publications/Riegler_2017_Deep_Branch_Ulnar_Nerve.pdf" },
    { text: "Riegler G, Pivec C, Platzgummer H, Lieba-Samal D, Brugger P, Jengojan S, Vierhapper M, Bodner G. High-resolution ultrasound visualization of the recurrent motor branch of the median nerve: normal and first pathological findings. Eur Radiol. 2017", pdf: "/publications/Riegler_2017_Recurrent_Motor_Branch_Median_Nerve.pdf" },
    { text: "Riegler G, Drlicek G, Kronnerwetter C, Heule R, Bieri O, Bodner G, Lieba-Samal D, Trattnig S. High-Resolution Axonal Bundle (fascicle) Assessment and Triple-Echo Steady-State T2 Mapping of the Median Nerve at 7 Tesla: Preliminary Experience. Invest Radiol. 2016", pdf: "/publications/Riegler_2016_Axonal_Bundle_7Tesla.pdf" }
  ];
